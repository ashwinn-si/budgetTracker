        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="relative flex-1 max-w-sm">
            ...
            <input
              ...
              className="w-full min-w-0 max-w-full pl-10 pr-4 py-2 text-base sm:text-sm bg-white/50 dark:bg-black/40 border border-white/60 dark:border-white/10 rounded-xl outline-none focus:ring-2 focus:ring-teal-500/40 text-[var(--text-primary)] placeholder:text-[var(--text-muted)]"
            />
          </div>
        </div>
      </GlassCard>
